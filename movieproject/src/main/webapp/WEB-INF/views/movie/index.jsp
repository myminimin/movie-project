		...
		<div class="hero__slider owl-carousel">
			<c:forEach items="${mList}" var="movie">
				<div class="hero__items set-bg"
					data-setbg="/resources/img/movie/${movie.movie_image}.jpg">
					<div class="row">
						<div class="col-lg-6">
							<div class="hero__text">
								...
								<a
									href='/movie/details?movie_id=<c:out value="${movie.movie_id}"/>'><span>Detail</span>
				...
				<div class="hero__items set-bg"
					data-setbg="/resources/img/hero/${movie.movie_image}-2.jpg">
					<div class="row">
						<div class="col-lg-6">
							<div class="hero__text">
								<div class="label"></div>
